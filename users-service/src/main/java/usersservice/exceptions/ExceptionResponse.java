...
public class ExceptionResponse {
    ...
    public static class ResponseBuilder {
        ...
        public usersservice.exceptions.ExceptionResponse get() {
            return new usersservice.exceptions.ExceptionResponse(errorCode, errorMessage, timestamp, stackTrace, errors, params);
        }
